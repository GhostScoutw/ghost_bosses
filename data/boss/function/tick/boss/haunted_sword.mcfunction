...
#idle particles
execute if entity @s[tag=!aj.haunted_sword.animation.slash.playing,tag=!aj.haunted_sword.animation.cut.playing] run particle trial_spawner_detection ~ ~1.5 ~ 0.3 1 0.3 0 3
...
execute if entity @s[tag=target.exists] at @s run function boss:tick/boss/haunted_sword/move_to_target
