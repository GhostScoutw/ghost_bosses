...
execute if entity @s[tag=!aj.haunted_sword.animation.slash.playing,tag=!aj.haunted_sword.animation.cut.playing,tag=!aj.haunted_sword.animation.shockwave.playing] if entity @p[tag=this.target,distance=3..] if block ^ ^ ^0.15 air run tp @s ^ ^ ^0.15 facing entity @p[tag=this.target]
...
execute if entity @s[tag=!aj.haunted_sword.animation.slash.playing,tag=!aj.haunted_sword.animation.cut.playing,tag=!aj.haunted_sword.animation.shockwave.playing] if entity @p[tag=this.target,distance=3..] if block ^ ^-1 ^ air run tp @s ^ ^-1 ^
