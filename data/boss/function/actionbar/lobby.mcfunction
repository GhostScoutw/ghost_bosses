...
modify storage boss:temp temp.actionbar append value [{"text": " +","color":"light_purple"},{"score": {"name": "@n[tag=boss,tag=!boss_solo,scores={ghost.boss.heal=1..}]","objective": "ghost.boss.heal"},"color":"light_purple"},{"text": "❤","color":"light_purple"}]
