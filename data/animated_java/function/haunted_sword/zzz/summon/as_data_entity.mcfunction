...
execute on vehicle on passengers if entity @s[tag=aj.haunted_sword.node.body] run function animated_java:global/internal/gu/convert_uuid_array_to_string
